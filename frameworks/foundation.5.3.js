$(function() {
    ...
    $('body').one('pinegrow-ready', function(e, pinegrow) {
        var f = new PgFramework('foundation.5.3', 'Foundation 5.3');
        f.type = "foundation";
                ...
                'data' : {
                    ...
                    fields : {
                        'fdtype' : {
                            ...
                            get_value: function(obj) {
                                var $el = obj.data;
                                return $el.find('input').attr('type');
                            },
                            set_value: function(obj, value, values, oldValue, eventType) {
                                var $el = obj.data;
                                $el.find('input').attr('type', value);
...
*/
    ...
    <tbody>\
        ...
        section.setComponentTypes( getTypes(['fd-form', 'fd-label', 'fd-label-only', 'fd-input', 'fd-switch', 'fd-textarea', 'fd-select', 'fd-button', 'fd-fieldset', 'fd-prefix', 'fd-postfix', 'fd-error']));
        f.addLibSection(section);
