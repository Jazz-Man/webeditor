!function (e) {
    ...
    function _(e) {
        return function (t, _) {
            return t.match(e) ? _.tokenize = null : t.skipToEnd(), "string"
        }
    }

    function r(e) {
        return 0 == e.length ? s : function (t, _) {
            for (var i = e[0], l = 0; l < i.length; l++)if (t.match(i[l][0]))return _.tokenize = r(e.slice(1)), i[l][1];
            return _.tokenize = s, "string"
        }
    }
    ...
    function s(e, t) {
        ...
        for (; !(e.eol() || e.match("{$", !1) || e.match(/(\$[a-zA-Z_][a-zA-Z0-9_]*|\$\{)/, !1) && !s);) {
            if (_ = e.next(), !s && '"' == _) {
                i = !0;
                break
            }
        ...
        return i && (t.tokenize = null, t.phpEncapsStack.pop()), "string"
    }
    ...
    e.registerHelper("hintWords", "php", [i, l, n].join(" ").split(" ")), e.registerHelper("wordChars", "php", /[\w$]/);
    var a = {
        name: "clike",
        helperType: "php",
        keywords: t(i),
        ...
        hooks: {
            $: function (e) {
                ...
                return e.match(/<</) ? (e.eatWhile(/[\w\.]/), t.tokenize = _(e.current().slice(3)), t.tokenize(e, t)) : !1
            }, "#": function (e) {
                ...
                return t.phpEncapsStack || (t.phpEncapsStack = []), t.phpEncapsStack.push(0), t.tokenize = s, t.tokenize(e, t)
            }, "{": function (e, t) {
                return t.phpEncapsStack && t.phpEncapsStack.length > 0 && t.phpEncapsStack[t.phpEncapsStack.length - 1]++, !1
            }, "}": function (e, t) {
                return t.phpEncapsStack && t.phpEncapsStack.length > 0 && 0 == --t.phpEncapsStack[t.phpEncapsStack.length - 1] && (t.tokenize = s), !1
            }
        }
    };
    e.defineMode("php", function (t, _) {
        function r(e, t) {
            var _ = t.curMode == i;
            if (e.sol() && t.pending && '"' != t.pending && "'" != t.pending && (t.pending = null), _)return _ && null == t.php.tokenize && e.match(/(\?|<\/php)>/) ? (t.curMode = s, t.curState = t.html, "meta") : i.token(e, t.curState);
            if (e.match(/^<(\?|php)\w*/))return t.curMode = i, t.curState = t.php, "meta";
            ...
            } else var r = s.token(e, t.curState);
            t.pending && (t.pending = null);
            var l, n = e.current(), a = n.search(/<(\?|php)/);
            return -1 != a && (t.pending = "string" == r && (l = n.match(/[\'\"]$/)) && !/(\?|<\/php)>/.test(n) ? l[0] : {
                end: e.pos,
                style: r
            }, e.backUp(n.length - a)), r
        }

        var s = e.getMode(t, "text/html"), i = e.getMode(t, a);
        return {
            startState: function () {
                var t = e.startState(s), r = e.startState(i);
                return {html: t, php: r, curMode: _.startOpen ? i : s, curState: _.startOpen ? r : t, pending: null}
            }, copyState: function (t) {
                var _, r = t.html, l = e.copyState(s, r), n = t.php, a = e.copyState(i, n);
                return _ = t.curMode == s ? l : a, {
                    html: l,
                    php: a,
                    curMode: t.curMode,
                    curState: _,
                ...
                return e.curMode != i && /^\s*<\//.test(t) || e.curMode == i && /^(\?|<\/php)>/.test(t) ? s.indent(e.html, t) : e.curMode.indent(e.curState, t)
